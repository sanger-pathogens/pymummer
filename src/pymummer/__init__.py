...
if missing_progs:
    print('The following required programs from the MUMmer package are not found in your PATH:', file=sys.stderr)
    for prog in missing_progs:
        print(f'   NOT FOUND: {prog}', file=sys.stderr)
    raise ImportError('Some required MUMmer programs are missing. Please install them and ensure they are in your PATH.')
